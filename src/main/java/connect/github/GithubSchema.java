...
//    public static String FIELD_GITHUB_ISSUE_LABELS = "labels";
    ...
    public static String FIELD_GITHUB_LABEL_ID = "id";
    public static String FIELD_GITHUB_LABEL_NODE_ID = "node_id";
    public static String FIELD_GITHUB_LABEL_NAME = "name";
    public static String FIELD_GITHUB_LABEL_COLOR = "color";
    public static String FIELD_GITHUB_LABEL_DEFAULT = "default";
    public static String FIELD_GITHUB_LABEL_URL = "url";
    ...
    public static Schema labelsSchema;

    static {
        labelsSchema = SchemaBuilder.struct().name("github.label")
                .field(FIELD_GITHUB_LABEL_ID, Schema.INT64_SCHEMA)
                .field(FIELD_GITHUB_LABEL_NODE_ID, Schema.STRING_SCHEMA)
                .field(FIELD_GITHUB_LABEL_NAME, Schema.STRING_SCHEMA)
                .field(FIELD_GITHUB_LABEL_COLOR, Schema.STRING_SCHEMA)
                .field(FIELD_GITHUB_LABEL_DEFAULT, Schema.BOOLEAN_SCHEMA)
                .field(FIELD_GITHUB_LABEL_URL, Schema.STRING_SCHEMA)
                .build();
    }
